...
class ArenaController:AbstractArena() {
    ...
    private fun playerOnesTurn(player: PlayerController, enemy: PlayerController){
        ...
        when(option){
            ...
            7 -> {
                print("Descartar a carta numero: ")
                val option = readln().toInt()
                this.playerOne.setCardsDestroyed(this.playerOne
                    .getOneCard(option))
    ...
    private fun playerTwosTurn(player: PlayerController, enemy: PlayerController){
        ...
        when(option){
            ...
            7 -> {
                print("Descartar a carta numero: ")
                val option = readln().toInt()
                this.playerOne.setCardsDestroyed(this.playerTwo
                    .getOneCard(option))
    ...
    override fun nextRound() {
        ...
        try {
            ...
            if(this.playerTwo.getCardsInGame().size < 5){
                this.playerTwo.getCardsInGame().add(mapCard2)
            }
        }catch (e: Exception){
            finish()
        }
